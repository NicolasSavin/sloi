...
const ALIAS: [RegExp, string][] = [
  ...
  [/евро.?франк|eurchf/i, "EURCHF"],
  [/евро.?ауд|euraud/i, "EURAUD"],
  [/фунт.?ауд|gbpaud/i, "GBPAUD"],
  [/ауд.?иен|audjpy/i, "AUDJPY"],
  [/кад.?иен|cadjpy/i, "CADJPY"],
  [/нзд.?иен|киви.?иен|nzdjpy/i, "NZDJPY"],
