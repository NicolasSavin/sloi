...
export function Landing({ data }: { data: HomePayload }) {
  return (
    <div className="min-h-dvh">
      ...
      <section className="relative mx-auto max-w-[1100px] px-3 pt-4 sm:px-6">
        <BrandMark />
        <p className="-mt-1 mb-2 font-mono text-xs tracking-[0.28em] text-accent">слои рынка · {DOMAIN}</p>
      </section>
      <HomeLeadPoster quotes={data.quotes} />
      <div className="mx-auto flex max-w-6xl flex-wrap gap-3 px-4 pb-4 sm:px-6">
        <Link
          to="/dispatch"
