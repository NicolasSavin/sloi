...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "Скачать советник",
    d: "В кабинете нажмите скачать SLOI_Desk.mq4 (версия 4.50). Ключ уже прописан в поле DeskKey. Если браузер не качает — код копируется, в MetaEditor: Файл → Создать → Expert Advisor → вставить всё → сохранить как SLOI_Desk.",
  },
  {
    n: "03",
    t: "Положить в MT4",
