...
const FAQ = [
  ...
  {
    q: "Сигналы в мой Telegram?",
    a: "Да. Создайте бота у @BotFather, добавьте его админом в канал. В Vercel: TELEGRAM_BOT_TOKEN и TELEGRAM_CHANNEL (@имяканала). Redeploy. Проверка: кнопка «тест в Telegram» в кабинете. Стол шлёт новый лонг/шорт и итог (тейк/стоп/не состоялся).",
  },
  {
...
const TERMS = [
  ...
  { k: "Маржа толпы", v: "21% диапазона у хая/лоя: стопы и маржин-коллы розницы. Топливо крупняка. Не сплэш и не вливание — те про объём CD." },
