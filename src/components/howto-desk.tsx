...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "Скачать советник",
    d: "В кабинете скачайте SLOI_Desk.mq4 (должно быть 4.52 в шапке файла). Положите в MQL4\\Experts, заменив старый. В навигаторе не должно быть SLOI_Desk (4), (8), (23), (37) — это старые компиляции. Один файл, F7, на график один экземпляр. В окне «О программе» будет 4.52.",
  },
  {
    n: "03",
    t: "Положить в MT4",
