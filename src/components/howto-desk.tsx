...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "Скачать советник",
    d: "В кабинете скачайте SLOI_Desk.mq4 (должно быть 4.53 в шапке файла). Положите в MQL4\\Experts, заменив старый. В навигаторе не должно быть SLOI_Desk (4), (8), (23), (37) — это старые компиляции. Один файл, F7, на график один экземпляр. В окне «О программе» будет 4.53.",
  },
  {
    n: "03",
    t: "Положить в MT4",
...
const FAQ = [
  {
    ...
    a: "Советник один. На EURUSD и XAUUSD: #Volumes, #Delta, #Infusion, #Splash, плюс #MarketProfile и #BookMap. Сов 4.53 шлёт POC/стакан на сайт. Если буферы CD пустые — стол сам на своей оценке.",
  },
  {
