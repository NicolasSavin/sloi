...
const FAQ = [
  {
    ...
    a: "Посетителям сайта — нет. Разбор объёмов идёт с терминала хозяина. Клиентский сов CD не спрашивает. Хозяину: евро и золото, индюки ClusterDelta, HostFeed=true.",
  },
  {
