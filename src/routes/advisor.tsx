      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <ol className="mt-12 space-y-3">
          {[
            ...
            { n: "03", t: "WebRequest", d: "Сервис → Настройки → Советники → разрешить WebRequest на адрес, где сайт реально открывается (не sloi.gold — этого домена нет). Пока сайт только в превью Grok, терминал его не видит." },
            { n: "04", t: "Лента", d: "В панели поле «лента»: https://ВАШ-САЙТ/api/signals.txt — тот же хост, что в браузере после публикации. Суффикс брокера (у вас cs) не стирайте." },
