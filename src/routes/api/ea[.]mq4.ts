...
function readyEa() {
  ...
  src = src.replace('#property version   "4.41"', '#property version   "4.43"');
  src = src.replace('#property version   "4.42"', '#property version   "4.44"');
  src = src.replace('#property version   "4.43"', '#property version   "4.45"');
  src = src.replace('#property version   "4.44"', '#property version   "4.46"');
  src = src.replace('#property version   "4.45"', '#property version   "4.47"');
  src = src.replace('#property version   "4.46"', '#property version   "4.48"');
  src = src.replace('#property version   "4.47"', '#property version   "4.49"');
  src = src.replace('#property version   "4.48"', '#property version   "4.49"');
  src = src.replace(
