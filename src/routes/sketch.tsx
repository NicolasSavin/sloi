  ...
  return (
    <div className="mt-6 rounded-2xl border border-amber-200/30 bg-black/40 p-4">
      ...
      <p className="mt-2 text-xs leading-relaxed text-zinc-400">
        {plan.own
          ? "Готовых цен на картинке не было. Стол поставил их сам: вход у текущей цены или у своей зоны, стоп за ближайшим экстремумом, тейк у ближайшей ликвидности. Советник ещё чуть поправит их на спред."
